#
#  Be sure to run `pod spec lint HHZCategory.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "陈哲是个好孩子-分类"

  s.homepage     = "https://github.com/chenzhe555/HHZCategory"
  ...
  s.source       = { :git => "https://github.com/chenzhe555/HHZCategory.git", :tag => "#{s.version}" }
